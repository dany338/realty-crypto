...
import { ILoadMoreProps } from '../../identity';

const LoadMore: React.FC<ILoadMoreProps> = ({ startPage, onClick, typeQuery }) => (
  <Container data-testid="loadmore-container">
    <Wrapper onClick={() => onClick(startPage + 9, 9, 'LoadMore', typeQuery, true)}>
      <span>Load more</span>
